...
struct Producer : public rclcpp::Node
{
            ...
            : Node(name, rclcpp::NodeOptions().use_intra_process_comms(true))
    {
        ...
        auto callback = [captured_pub,bytedata]() -> void {
            ...
            printf("Published message with value: , and address: 0x%" PRIXPTR "\n",
...
struct Consumer2 : public rclcpp::Node
{
            ...
            : Node(name, rclcpp::NodeOptions().use_intra_process_comms(true))
    {
        ...
        sub_ = this->create_subscription<std_msgs::msg::String>(
                ...
                10,
                [](std_msgs::msg::String::UniquePtr msg) {
                    printf("2 Received message with value:, and address: 0x%" PRIXPTR "\n",
                            reinterpret_cast<std::uintptr_t>(msg.get()));
                });
    }
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr sub_;
...
struct Consumer3 : public rclcpp::Node
{
            ...
            : Node(name, rclcpp::NodeOptions().use_intra_process_comms(true))
    {
        ...
        sub_ = this->create_subscription<std_msgs::msg::String>(
                ...
                10,
                [](std_msgs::msg::String::UniquePtr msg) {
                    printf("3 Received message with value:, and address: 0x%" PRIXPTR "\n",
                           reinterpret_cast<std::uintptr_t>(msg.get()));
                });
    }
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr sub_;
