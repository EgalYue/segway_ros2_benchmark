...
bool fixed_size_msgs__msg__image4k__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "fixed_size_msgs.msg._image4k.Image4k",
        full_classname_dest, 36) == 0);
  }
  fixed_size_msgs__msg__Image4k * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of Image4k */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fixed_size_msgs.msg._image4k");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Image4k");
  ...
  {  // data
    ...
    memcpy(dst, src, 24883200 * sizeof(uint8_t));
    Py_DECREF(field);
  }
