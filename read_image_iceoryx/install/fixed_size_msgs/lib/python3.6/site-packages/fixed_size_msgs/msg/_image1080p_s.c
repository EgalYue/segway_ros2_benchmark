...
bool fixed_size_msgs__msg__image1080p__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "fixed_size_msgs.msg._image1080p.Image1080p",
        full_classname_dest, 42) == 0);
  }
  fixed_size_msgs__msg__Image1080p * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of Image1080p */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fixed_size_msgs.msg._image1080p");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Image1080p");
