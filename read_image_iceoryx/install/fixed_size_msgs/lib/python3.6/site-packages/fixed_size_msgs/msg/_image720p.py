...
class Metaclass_Image720p(type):
    """Metaclass of message 'Image720p'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'fixed_size_msgs.msg.Image720p')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__image720p
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__image720p
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__image720p
            cls._TYPE_SUPPORT = module.type_support_msg__msg__image720p
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__image720p
    ...
    def HEIGHT(self):
        ...
        return Metaclass_Image720p.__constants['HEIGHT']

    @property
    def WIDTH(self):
        """Message constant 'WIDTH'."""
        return Metaclass_Image720p.__constants['WIDTH']

    @property
    def CHANNELS(self):
        """Message constant 'CHANNELS'."""
        return Metaclass_Image720p.__constants['CHANNELS']


class Image720p(metaclass=Metaclass_Image720p):
    """
    Message class 'Image720p'.
    ...
    def __init__(self, **kwargs):
        ...
        if 'data' not in kwargs:
            ...
            assert self.data.shape == (2764800, )
