...
#include "fixed_size_msgs/msg/image720p__rosidl_typesupport_opensplice_cpp.hpp"
...
using __dds_msg_type_Image720p = fixed_size_msgs::msg::dds_::Image720p_;
using __ros_msg_type_Image720p = fixed_size_msgs::msg::Image720p;

static fixed_size_msgs::msg::dds_::Image720p_TypeSupport __type_support_Image720p;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_fixed_size_msgs
const char *
register_type__Image720p(
  ...
  const char * type_name)
{
  ...
  DDS::ReturnCode_t status = __type_support_Image720p.register_type(participant, type_name);
  switch (status) {
...
convert_ros_message_to_dds(
  const __ros_msg_type_Image720p & ros_message,
  __dds_msg_type_Image720p & dds_message)
{
  ...
  const void * untyped_ros_message)
{
  ...
  const __ros_msg_type_Image720p & ros_message = *static_cast<const __ros_msg_type_Image720p *>(untyped_ros_message);
  __dds_msg_type_Image720p dds_message;
...
convert_dds_message_to_ros(
  const __dds_msg_type_Image720p & dds_message,
  __ros_msg_type_Image720p & ros_message)
{
  // member.name timestamp
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    __ros_msg_type_Image720p & ros_message = *static_cast<__ros_msg_type_Image720p *>(untyped_ros_message);
  ...
  void * untyped_serialized_data)
{
  ...
  DDS::OpenSplice::CdrTypeSupport cdr_ts(__type_support_Image720p);
...
static message_type_support_callbacks_t Image720p_callbacks = {
  "fixed_size_msgs::msg",
  "Image720p",
  &register_type__Image720p,
  &publish__Image720p,
...
static rosidl_message_type_support_t Image720p_handle = {
...
{
  return &fixed_size_msgs::msg::typesupport_opensplice_cpp::Image720p_handle;
}
