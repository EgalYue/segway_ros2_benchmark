...
bool fixed_size_msgs__msg__image720p__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "fixed_size_msgs.msg._image720p.Image720p",
        full_classname_dest, 40) == 0);
  }
  fixed_size_msgs__msg__Image720p * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of Image720p */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fixed_size_msgs.msg._image720p");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Image720p");
