...
class Metaclass_Image1080p(type):
    """Metaclass of message 'Image1080p'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'fixed_size_msgs.msg.Image1080p')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__image1080p
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__image1080p
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__image1080p
            cls._TYPE_SUPPORT = module.type_support_msg__msg__image1080p
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__image1080p
    ...
    def HEIGHT(self):
        ...
        return Metaclass_Image1080p.__constants['HEIGHT']

    @property
    def WIDTH(self):
        """Message constant 'WIDTH'."""
        return Metaclass_Image1080p.__constants['WIDTH']

    @property
    def CHANNELS(self):
        """Message constant 'CHANNELS'."""
        return Metaclass_Image1080p.__constants['CHANNELS']


class Image1080p(metaclass=Metaclass_Image1080p):
    """
    Message class 'Image1080p'.
