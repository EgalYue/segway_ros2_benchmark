...
bool fixed_size_msgs__msg__image_vga__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "fixed_size_msgs.msg._image_vga.ImageVGA",
        full_classname_dest, 39) == 0);
  }
  fixed_size_msgs__msg__ImageVGA * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of ImageVGA */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fixed_size_msgs.msg._image_vga");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageVGA");
  ...
  {  // data
    ...
    memcpy(dst, src, 921600 * sizeof(uint8_t));
    Py_DECREF(field);
  }
