...
#include "fixed_size_msgs/msg/image720p__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const fixed_size_msgs::msg::Image720p *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fixed_size_msgs::msg::Image720p *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Image720p__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fixed_size_msgs::msg::Image720p *>(
...
{
  return max_serialized_size_Image720p(full_bounded, 0);
}

static message_type_support_callbacks_t _Image720p__callbacks = {
  "fixed_size_msgs::msg",
  "Image720p",
...
static rosidl_message_type_support_t _Image720p__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Image720p__callbacks,
...
{
  return &fixed_size_msgs::msg::typesupport_fastrtps_cpp::_Image720p__handle;
}
