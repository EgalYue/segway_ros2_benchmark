...
static const _Image1m_type_support_symbol_names_t _Image1m_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fixed_size_msgs, msg, Image1m)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fixed_size_msgs, msg, Image1m)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, fixed_size_msgs, msg, Image1m)),
  }
};
...
{
  return &::fixed_size_msgs::msg::rosidl_typesupport_cpp::Image1m_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fixed_size_msgs, msg, Image1m)() {
  return get_message_type_support_handle<fixed_size_msgs::msg::Image1m>();
}
