...
static const _Image720p_type_support_symbol_names_t _Image720p_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fixed_size_msgs, msg, Image720p)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fixed_size_msgs, msg, Image720p)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, fixed_size_msgs, msg, Image720p)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fixed_size_msgs, msg, Image720p)() {
  return &::fixed_size_msgs::msg::rosidl_typesupport_c::Image720p_message_type_support_handle;
}
